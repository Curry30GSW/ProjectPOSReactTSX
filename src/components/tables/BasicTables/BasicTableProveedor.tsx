...
interface ProveedorTableProps {
  reload?: boolean;
  onEditProveedor?: (proveedor: Proveedor) => void; // Nueva prop
}

export default function ProveedorTable({ reload, onEditProveedor }: ProveedorTableProps) {
  ...
  const paginatedProveedor = filteredProveedores.slice(
        ...
        <div className="min-w-[900px]">
          <Table>
            ...
            <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
              {paginatedProveedor.map((proveedor) => (
